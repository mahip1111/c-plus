...
int main()
{
    ...
    // (bcs apna sum fxn. ko call kiya hai and uska andar koi bhi global name ka local varibale nhi hai therefore global thre will be automatically global variable.)
